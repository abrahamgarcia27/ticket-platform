                            ...
                            <div class="fee-row mb-3">
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <input type="text" name="fees[{{ $index }}][name]" class="form-control fee-name" placeholder="Fee Name" value="{{ $fee->name }}">
                                    </div>
                                    <div class="col-5">
                                        <label class="form-control-label">Fee Amount</label>
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" name="fees[{{ $index }}][amount]" class="form-control fee-amount" placeholder="0.00" step="0.01" min="0" value="{{ $fee->amount }}">
                                        </div>
                                    </div>

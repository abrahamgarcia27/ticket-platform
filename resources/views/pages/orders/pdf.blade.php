                          ...
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              ...
                              <div style="border: 1px solid #d2c9c9;">
                                ...
                                <table class="container" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                  <tbody>
                                      <p class="" style="line-height: 24px; font-size: 10px; color: #545454; width: 100%; margin: 0; padding-top: 12px; margin-left: 15px;" align="left">*All event sales are final no reimbursements.</p>
                                  </tbody>
                                </table>
                              </div> 
                            </div>
